...
class MainWindow(QMainWindow):
	def __init__(self,height,width):
		...
		self.createUI()
		self.addCompany = QPushButton("Add Company")
		self.model = 1
		self.vbox = None
	...
	def createUI(self):
		...
		try:
			...
			#companies = QComboBox(self)
			self.companies.addItem("Facebook")
			...
			hbox1.addWidget(self.addCompany)
	...
	def predict(self):
		...
		if self._UseCompanies.isChecked():
			...
			#self.CurrentFile = 
			data = pre.readData("../Data/{}.csv".format(comp))		
